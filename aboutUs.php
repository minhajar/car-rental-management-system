     ...
     <section>
          <div class="container">
               <div class="text-center">
                    ...
                    <p class="lead">PITRENTALS. RENT YOUR CAR WHEREVER YOU ARE!</p>
               </div>
          </div>
     </section>
               ...
               <div class="row">
                    ...
                    <div class="col-md-7 col-xs-12">
                         <div class="about-info">
                              <h2>Preminum Car Rental Service in Morocco!</h2>

                              <figure>
                                   <figcaption>
                                        

                                        <p>Don't deny yourself the pleasure of driving your favourite car on a budget. </p>
                                   </figcaption>
                              </figure>
                         </div>
                    </div>
